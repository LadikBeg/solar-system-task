...
public class NeptuneClass implements Planets {
    ...
    public NeptuneClass(String Name, Double DistanceFromTheSun, Double Weight, Integer Radius, Integer CirculationPeriod,
